@echo off
title Telegram Auto Message Bot (No Cooldown)
chcp 65001 >nul
...
echo ========================================
echo   Telegram Auto Message Bot (No Cooldown)
echo ========================================
echo.
...
REM 파이썬 스크립트 실행 (쿨타임 없음)
echo 🤖 텔레그램 봇을 시작합니다 (쿨타임 없음)...
python userbot_sender_no_cooldown.py
